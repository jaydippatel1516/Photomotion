package com.photomotion.lightricks.photoeditor.customView.controllersapp;
...
import com.photomotion.lightricks.photoeditor.activity.PhotoMotionEditActivity;
import com.photomotion.lightricks.photoeditor.adapter.PhotomotionEffectAdapter;
import com.photomotion.lightricks.photoeditor.adapter.StickerAdapter;
...
import com.photomotion.lightricks.photoeditor.customView.beans.Ponto;
import com.photomotion.lightricks.photoeditor.customView.beans.TrianguloBitmap;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.AnimacaoController.IteradorDePonto;
...
public class ToolsController implements OnClickListener {
    ...
    public PhotomotionEffectAdapter moEffectAdapter;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btApagarMascara:
                ...
                stopPreview();
                PhotoMotionEditActivity.object.moStickerView.hideFrame(true);
            ...
            case R.id.btEffect:
                ...
                PhotomotionEffectAdapter effectAdapter = this.moEffectAdapter;
                if (!(effectAdapter == null || effectAdapter.getSelectedEffect().getEffectId() == -1)) {
                    PhotoMotionEditActivity.object.moIvGif.setVisibility(View.VISIBLE);
                    PhotoMotionEditActivity.object.moIvGif.playAnimation();
                }
                return;
            ...
            case R.id.btSticker:
                ...
                stopPreview();
                PhotoMotionEditActivity.object.moStickerView.hideFrame(false);
                this.isApagandoMascara = false;
    ...
    public void playPreview() {
        ...
        this.subToolVelocidade.setVisibility(View.VISIBLE);
    ...
    public void resetStickerAdapter() {
        if (this.moStickerAdapter != null) {
            PhotoMotionEditActivity.object.moStickerView.setVisibility(View.GONE);
    ...
    public void setEffectAdapter(Bitmap bitmap) {
        ...
        this.moEffectAdapter = new PhotomotionEffectAdapter(this.activity, this.moEffectlist, bitmap3, new OnClickListner() {
            public final void onClick(EffectData effectData, int i) {
                if (effectData.getEffectId() != -1) {
                    PhotoMotionEditActivity.object.moIvGif.setSpeed(1.0f);
                    PhotoMotionEditActivity.object.moIvGif.setAnimation(effectData.getEffectName());
                    if (!effectData.getEffectGIFPath().isEmpty()) {
                        PhotoMotionEditActivity.object.moIvGif.setImageAssetsFolder(effectData.getEffectGIFPath());
                    }
                    PhotoMotionEditActivity.object.moIvGif.playAnimation();
                    int height = PhotoMotionEditActivity.object.imageView.getHeight();
                    int width = PhotoMotionEditActivity.object.imageView.getWidth();
                    int intrinsicHeight = PhotoMotionEditActivity.object.imageView.getDrawable().getIntrinsicHeight();
                    int intrinsicWidth = PhotoMotionEditActivity.object.imageView.getDrawable().getIntrinsicWidth();
                    ...
                    PhotoMotionEditActivity.object.moRLEffects.setLayoutParams(layoutParams);
                    PhotoMotionEditActivity.object.moIvGif.setScaleType(ScaleType.CENTER_CROP);
                    PhotoMotionEditActivity.object.moIvGif.setVisibility(View.VISIBLE);
                    PhotoMotionEditActivity.object.moEffectData = effectData;
        ...
        this.moStickerAdapter = new StickerAdapter(this.activity, this.moStickerList, bitmap3, new OnStickerClickListner() {
            public final void onClick(StickerData stickerData, int i) {
                if (stickerData.getStickerId() != -1) {
                    PhotoMotionEditActivity.object.moStickerView.hideFrame(false);
                    PhotoMotionEditActivity.object.moStickerView.setVisibility(View.VISIBLE);
                    PhotoMotionEditActivity.object.moStickerView.setAnimation(stickerData.getStickerName(), stickerData.getStickerFolderNameFPath());
                    PhotoMotionEditActivity.object.moStickerView.playAnimation();
                    int height = PhotoMotionEditActivity.object.imageView.getHeight();
                    int width = PhotoMotionEditActivity.object.imageView.getWidth();
                    int intrinsicHeight = PhotoMotionEditActivity.object.imageView.getDrawable().getIntrinsicHeight();
                    int intrinsicWidth = PhotoMotionEditActivity.object.imageView.getDrawable().getIntrinsicWidth();
                    ...
                    layoutParams.addRule(13, -1);
                    PhotoMotionEditActivity.object.moRLEffects.setLayoutParams(layoutParams);
                    PhotoMotionEditActivity.object.moStickerView.setScaleType();
                    PhotoMotionEditActivity.object.moStickerView.setVisibility(View.VISIBLE);
                    PhotoMotionEditActivity.object.moStickerData = stickerData;
    ...
    public void setSubToolTamanhoPincelVisibility(boolean z) {
        this.subToolTamanho.setVisibility(z ? View.VISIBLE : View.INVISIBLE);
    }


    public void setSubToolVelocidadeVisibility(boolean z) {
        this.subToolVelocidade.setVisibility(z ?  View.VISIBLE :  View.INVISIBLE);
    }
    ...
    public void stopPreview() {
        this.playingPreview = false;
        this.subToolVelocidade.setVisibility(View.INVISIBLE);
        PhotoMotionEditActivity.object.moIvGif.setVisibility(View.GONE);
        ToolsListener toolsListener2 = this.toolsListener;
        if (toolsListener2 != null) {
