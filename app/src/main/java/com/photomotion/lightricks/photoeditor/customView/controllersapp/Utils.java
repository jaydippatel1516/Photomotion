...
public class Utils {
    ...
    public static float dpiToPixels(float f) {
        return TypedValue.applyDimension(1, f, PhotoMotionEditActivity.metrics);
    }
    ...
    public static void scannFile(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            mSelectedImageUri = FileProvider.getUriForFile(context, context.getPackageName() + ".provider", file);
        }
