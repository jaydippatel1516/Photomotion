package com.photomotion.lightricks.photoeditor.customView.beans;
...
import com.photomotion.lightricks.photoeditor.activity.PhotomotionSavingActivity;
...
public class Projeto implements Parcelable {
    ...
    public void setResolucaoSave(int i) {
        if (i < PhotomotionSavingActivity.MIN_RESOLUTION_SAVE) {
            this.resolucaoSave = PhotomotionSavingActivity.MIN_RESOLUTION_SAVE;
        } else if (i > PhotomotionSavingActivity.MAX_RESOLUTION_SAVE) {
            this.resolucaoSave = PhotomotionSavingActivity.MAX_RESOLUTION_SAVE;
        } else {
