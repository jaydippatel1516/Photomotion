package com.photomotion.lightricks.photoeditor.photoAlbum;
...
public class PhotomotionAlbumAdapter extends Adapter<PhotomotionAlbumAdapter.MyViewHolder> {
    ...
    public PhotomotionAlbumAdapter(Context context, ClickListener clickListener2) {
        mContext = context;
