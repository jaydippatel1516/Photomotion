...
import com.photomotion.lightricks.photoeditor.callback.OnBitmapListCreated;
import com.photomotion.lightricks.photoeditor.R;
import com.photomotion.lightricks.photoeditor.customView.CustomAnimationView;
import com.photomotion.lightricks.photoeditor.customView.LupaImageView;
import com.photomotion.lightricks.photoeditor.customView.ShareClass;
import com.photomotion.lightricks.photoeditor.customView.ZoomImageView;
...
import com.photomotion.lightricks.photoeditor.customView.controllersapp.AnimacaoController;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.AnimacaoController.AnimateListener;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.HistoryController;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.HistoryController.ObjetoHistoria;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.ToolsController;
import com.photomotion.lightricks.photoeditor.customView.controllersapp.ToolsController.ToolsListener;
...
import com.photomotion.lightricks.photoeditor.utils.BitmapHelper;
...
public class PhotoMotionEditActivity extends AppCompatActivity {
    public static DisplayMetrics metrics;
    public static PhotoMotionEditActivity object;
    ...
    public void loadImagem(Uri uri) {
        ...
        try {
            ...
            if (i > PhotomotionSavingActivity.MAX_RESOLUTION_SAVE) {
                i = PhotomotionSavingActivity.MAX_RESOLUTION_SAVE;
            }
...
//            sb.append(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR);
    ...
    public void onBackPressed() {
        if (PhotomotionGalleryListActivity.getGalleryActivity() != null) {
            PhotomotionGalleryListActivity.getGalleryActivity().finish();
        }
        PhotomotionAlbumListActivity albumImagesActivity = PhotomotionAlbumListActivity.activity;
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_save:
                        ...
                        if (ToolsController.controller.getCurrentStickerPosition() == -1 && ToolsController.controller.getSelecetdEffect().getEffectId() == -1) {
                            ...
                            Intent intent = new Intent(PhotoMotionEditActivity.this, PhotomotionSavingActivity.class);
                            intent.putExtra(PhotomotionSavingActivity.INTENT_PROJETO, projetoAtual);
                            startActivity(intent);

                        } else {
                            moStickerView.hideFrame(true);
                            moDialog = new ProgressDialog(PhotoMotionEditActivity.this);
            ...
            if (imageLoaded) {
                ...
                if (!toolsController.isPlayingPreview()) {
                    ...
                    if (motionEvent.getAction() == 0) {
                        ...
                        xInitMouse = f;
                        yInitMouse = f2;
                        pontoInicial = new Ponto(PhotoMotionEditActivity.this.xInitMouse, yInitMouse, true);
                        switch (toolsController.getTipoFerramenta()) {
                            case 1:
                                pontoInicial = new Ponto(PhotoMotionEditActivity.this.xInitMouse, yInitMouse, false);
                                ...
                                break;
                            case 2:
                                reposicionarLupa(PhotoMotionEditActivity.this.xInitMouse, yInitMouse);
                                carregarImagemRepresentacao();
                        ...
                        carregarImagemRepresentacao();
                        carregarMenus(PhotoMotionEditActivity.this.menuSecundario);
                        return true;
                    }
                }
            }
    ...
    public class toolsListener implements ToolsListener {
        ...
        public void onPressDelete() {
            ...
            imageView.setZoomActivated(false);
            carregarImagemRepresentacao();
            PhotoMotionEditActivity editActivity = PhotoMotionEditActivity.this;
        ...
        public void onStopPreview() {
            ...
            if (animacaoController != null) {
                animacaoController.stopAnimation(PhotoMotionEditActivity.this);
            }
    ...
    public class C04688 implements ListenerPermissao {
        ...
        public void onPermissionGranted() {
            ...
            if (intent.resolveActivity(getPackageManager()) != null) {
                startActivityForResult(Intent.createChooser(intent, PhotoMotionEditActivity.this.getResources().getString(R.string.txt_select_an_image)), 1);
            }
        }
    }
    ...
    public class playPauseClick implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (toolsController.getSelecetdEffect().getEffectId() != -1) {
                ...
                moIvGif.setAnimation(PhotoMotionEditActivity.this.moEffectData.getEffectName());
                if (!moEffectData.getEffectGIFPath().isEmpty()) {
                    moIvGif.setImageAssetsFolder(PhotoMotionEditActivity.this.moEffectData.getEffectGIFPath());
                }
                moIvGif.playAnimation();
                moIvGif.setVisibility(View.VISIBLE);
            }
